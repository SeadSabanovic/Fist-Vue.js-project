...
<style>
  * {
  ...
  #app {
    background-image: url('https://images.unsplash.com/photo-1568789030916-892a2d3bc0ec?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80');
  ...
  #app.warm {
    background-image: url('https://images.unsplash.com/photo-1547241850-eb8a8754f95c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1782&q=80');
  }
